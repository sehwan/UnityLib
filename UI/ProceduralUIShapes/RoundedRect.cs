...
public class RoundedRect : Image
{
    ...
    public Vector2 shadowOffset = new(5, -5);
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        Vector2 roundedAndBorder = new(roundedValue, enableBorder ? borderThickness : 0);

        var uvs = GetUVValues(r);
        Vector2 uv1 = new(uvs.x, uvs.y);
        Vector2 uv2 = new(uvs.x, uvs.w);
        Vector2 uv3 = new(uvs.z, uvs.w);
        Vector2 uv4 = new(uvs.z, uvs.y);
